...
namespace ServerlessDemo.OrderFood
{
    ...
    public abstract class AbstractIntentProcessor : IIntentProcessor
    {
        ...
        protected string SerializeReservation(FoodOrder order)
        {
        ...
        protected FoodOrder DeserializeReservation(string json)
        {
            return JsonConvert.DeserializeObject<FoodOrder>(json);
        }
